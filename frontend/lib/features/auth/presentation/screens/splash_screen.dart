              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.security, size: 60, color: Color(0xFF1E3A8A)),
                  ),
                  const SizedBox(height: 32),
                  const Text(
                    'AppSecurity',
                    style: TextStyle(fontSize: 36, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 1.2),
                  ),
